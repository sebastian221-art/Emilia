      ...
      ayudaLista: "Se definen en código (src/flujos/). Acá elegís cuáles puede disparar." },
    {
      ...
      campos: [
        { t: "select", key: "modo", label: "Memoria conversacional",
          ops: [["por_sesion", "Recuerda dentro de cada conversación (resumen + últimos mensajes)"], ["ninguna", "Ninguna (cada mensaje arranca en blanco)"]],
          usa: "memoria.historialParaModelo" },
